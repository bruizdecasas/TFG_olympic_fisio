...
<body>
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate">Mis datos</h1>
							<h2 class="to-animate">En este apartado puedes ver los datos
								de tu perfil</h2>
						</div>
					</div>
				</div>
	...
	<div class="titulo">
		<a class="btn btn-primary"
			href="/usuario/editar/${ usuario.idUsuario }">Editar</a>

		<sec:authorize access="hasAuthority('Administrador')">
			<a class="btn btn-primary"
				href="/usuario/eliminar/${ usuario.idUsuario }">Eliminar</a>
		</sec:authorize>
	</div>
