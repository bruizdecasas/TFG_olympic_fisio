				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate">Mantenimiento de Roles</h1>
							<h2 class="to-animate">Gestion de los roles por parte del
								administrador</h2>
						</div>
					</div>
				</div>
	...
	<main>
		...
		<form action="/rol/alta" method="post">
			...
			<fieldset class="full-form">
				...
				<fieldset class="default">
					<label for="nombreRol">Nombre Rol</label> <input type="text"
						name="nombreRol" id="nombreRol" required />
				</fieldset>
