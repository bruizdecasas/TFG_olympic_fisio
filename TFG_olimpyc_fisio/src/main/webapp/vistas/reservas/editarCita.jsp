				...
				<div class="text-inner">
					<div class="row">
						<div class="">
							...
							<h2 class="to-animate">En este espacio puedes modificar tus
								citas</h2>
						</div>
					</div>
				</div>
			...
			<form class="form" action="/cita/editar" method="post">
				...
				<fieldset class="full-form">
					...
					<fieldset class="default">
						<fieldset class="default">
							<input type="hidden" name="idCita" id="idCita" required
								value="${ cita.idCita }" class="campos" /> <label
								for="fechaCita">Fecha</label> <input type="date"
								name="fechaCita" id="fechaCita" required class="campos" /> <label
								for="hora">Hora</label> <select name="horaCita" id="horaCita"
								required class="campos">
						...
						<fieldset class="default">
							<label for="observaciones">Observaciones (opcional)</label> <input
								type="text" name="observaciones" id="observaciones"
								class="campos" />
						</fieldset>
