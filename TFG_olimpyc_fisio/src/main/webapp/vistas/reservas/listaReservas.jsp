				...
				<div class="text-inner">
					<div class="row">
						<div class="">
							...
							<h2 class="to-animate">En este apartado puedes gestionar tus
								reservas</h2>
						</div>
					</div>
				</div>
			...
			<section class="default">
				...
				<c:choose>
					<c:when test="${empty listareservas}">
						<tr>
							<td colspan="5" class="vacias">No tienes realizada ninguna
								reserva</td>
						</tr>
					</c:when>
					<c:otherwise>
											...
											<ul class="card-actions">
												<sec:authorize
													...
													<td><a class="btn btn-primary"
														href="/reserva/cancelar/${ ele.idReserva }">Cancelar</a></td>
												</sec:authorize>
										</div>
									</div>
								</div>
