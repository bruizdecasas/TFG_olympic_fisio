				...
				<fieldset class="default">
					...
					<fieldset class="default">
						<label for="nombreProducto">Nombre</label> <input type="text"
							name="nombreProducto" id="nombre_producto" class="campos"
							required placeholder="${ producto.nombreProducto}" /> <label
							for="descripcion">Descripción</label> <input type="text"
							name="descripcion" id="descripcion" class="campos" required
